...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ticker = function (_Component2) {
	  ...
	  function Ticker(node, props) {
	    _classCallCheck(this, Ticker);
	
	    var _this2 = _possibleConstructorReturn(this, (Ticker.__proto__ || Object.getPrototypeOf(Ticker)).call(this, node, 'ticker', props));
	...
	var ticker = new Ticker(tickerElement, ['ticks']);
